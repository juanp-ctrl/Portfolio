...
export const paulaCalderon: Student = {
  ...
  name: 'Paula Andrea Calderón Quintero',

  // EN: A short biography about yourself (2-3 sentences)
  // ES: Una biografía corta sobre ti (2-3 oraciones)
  bio: 'Soy Tecnóloga en Desarrollo de Software, apasionada por crear soluciones tecnológicas que integran funcionalidad y diseño. Disfruto aprender, innovar y aportar valor a cada proyecto en el que participo.',
